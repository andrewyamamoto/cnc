...
function cnc_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'cnc_custom_background_args', array(
...
function cnc_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'cnc_content_width', 640 );
}
...
function cnc_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'cnc' ),
...
function cnc_scripts() {
	...
	wp_enqueue_script( 'cnc-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'cnc-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
